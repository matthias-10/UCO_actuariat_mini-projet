...
\subsection{X_prim}
X_prim will give a different estimator.
This could be shown analytically, as even for sigma = 0 the values will be different.
X_inf uses the method of trapezes, giving the area under the whole graph, whereas X_prim averages some values starting from T/Nd to T.
